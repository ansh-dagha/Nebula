...
const ssAddress = "0xE48af0695c8aF8cD90332E5e3cDCEDDb70aE5EB1";
...
window.addEventListener("load", function() {
    if (typeof window.ethereum !== "undefined") {
        ...
        if (window.ethereum.isMetaMask === true) {
            ...
            mmDetected.innerHTML += '<div class="alert alert-info" role="alert"> Please click "Connect Wallet" to sign in with Meta-Mask </div>';
            ...
            let mmDetected = document.getElementById("mm-detected");
            mmDetected.innerHTML += '<div class="alert alert-danger" role="alert"> MetaMask Not Available! </div>';
...
mmEnable.onclick = async() => {
    ...
    mmEnable.hidden = true;
    let details = document.getElementById("details");
    details.hidden = false;

    details.innerHTML = ethereum.selectedAddress + " | <b>ETH:</b> " + web3.utils.fromWei(balance) + " | <b>Network:<b/> " + network + " | <b>TVL:</b> " + web3.utils.fromWei(tvl) + "ETH";
...
ssSubmit.onclick = async() => {
    ...
    if (!!value) ssDisplayValue.innerHTML = "The address is registered successfully";
    else {
...
ssGetPartnerValue.onclick = async() => {
    ...
    if (ssInputValue != "") {
        ...
        ssPartnerValue.innerHTML = "Nebula Balance: 0";
        ...
        if (value == true) {
            ssDisplayValue.innerHTML = "The address is registered";
            ...
            ssDisplayValue.innerHTML = "The address was not registered";
        }
    }
};
...
ssGetCsutomerValue.onclick = async() => {
    ...
    if (value > 0) {
        ssDisplayValue.innerHTML = "Value: " + web3.utils.fromWei(value) + " ETH";
    }
};
...
ssEarnSubmit.onclick = async() => {
    ...
    setTimeout(() => {
        ssDisplayValue.innerHTML = '<div class="alert alert-success" role="alert" id="details" style="text-align: center;">Congrats! You have been rewarded 0.012 ETH</div>';
        document.getElementById("ss-display-earnvalue").innerHTML = "Nebula Balance: 0.112 ETH";
    }, 5000);
